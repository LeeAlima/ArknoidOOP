...
public class Paddle implements Sprite, Collidable {
    ...
    public void moveLeft(double dt) {
        ...
        this.rect
                .setUpperLeft(
                        new Point(this.rect.getUpperLeft().getX() - this.speed * dt,
    ...
    public void timePassed(double dt) {
        ...
        if (keyboard.isPressed(KeyboardSensor.LEFT_KEY)) {
            ...
            if (rect.getUpperRight().getX() < this.secondBound.getX() - this.speed * dt) {
                ...
                this.rect
                        .setUpperLeft(new Point(this.secondBound.getX() - this.rect.getWidth(),
    ...
    public void drawOn(DrawSurface d) {
        ...
        d.drawRectangle((int) x1, (int) y1, (int) x2, (int) y2);
        String s = null;
        for (int i = 0; i < x2 / 5 - 5; i++) {
            if (s == null) {
                s = " ";
            } else {
                s += " ";
        ...
        d.drawText((int) (x1 * 1), (int) (y1 + 14), s + "Paddle", 10);
    }
