...
public class Ball implements Sprite {
    ...
    public void moveOneStep() {
        ...
        if (collision == null) {
            ...
            // if the ball is on the right line of the left block
            if (xNew <= 800 / 30 + -1 * this.velocity.getDx()) {
                xNew = 800 / 30 + 2;
                this.velocity.setDx(Math.round(this.velocity.getDx()));
            }
            // if the ball is on the left line of the right block
            if (xNew >= 800 * 29 / 30 - this.velocity.getDx()) {
                xNew = 800 * 29 / 30 - 2;
                this.velocity.setDx(Math.round(this.velocity.getDx()));
